...
export function CompassSpriteProvider(): React.JSX.Element {
  return (
    ...
    >
      <defs>
        <symbol
          id="bridges.perspectives.contradicts"
        ...
        <symbol
          id="bridges.perspectives.enables"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-900"
        ...
        <symbol
          id="bridges.perspectives.extends"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-900"
        ...
        <symbol
          id="bridges.perspectives.fulfills"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-900"
        ...
        <symbol
          id="bridges.perspectives.matches"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-900"
        ...
        <symbol
          id="bridges.perspectives.supports"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-900"
        ...
        <symbol
          id="pursuit.prospect.flourishing"
          viewBox="0 0 419.53 297.64"
        >
          <path
        ...
        >
          ...
          />
          <path
            d="M156.1 17.06c-.03-.06-.1-.08-.15-.03-3.72 3.47-9.53 2.67-13.19 6.82-2.78 3.16-2.5 5.5-2.38 6.11.38 1.89 2.2 3.49 4.75 3.93 1.09.19 2.19.14 3.2-.1.48-.11.94-.27 1.37-.47 5.9-2.36 9.69-8.69 6.39-16.27z"
            fill="#e5cb82"
          />
        </symbol>
        <symbol
          id="zest.leisure.calm"
          viewBox="0 0 297.64 419.53"
        >
          <path
            className="fill-gray-50"
        ...
        <symbol
          id="zest.motivators.flexibility"
          viewBox="0 0 419.53 297.64"
        >
          <path
        ...
        <symbol
          id="zest.motivators.orientation"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-800"
        ...
        <symbol
          id="zest.motivators.possibilities"
          viewBox="0 0 419.53 297.64"
        >
          <path
            className="fill-gray-800"
